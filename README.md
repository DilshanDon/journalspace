...
JournalSpace is a browser-based personal notes and journal manager. You can create, read, update, and delete journal entries. Each entry has a title, content, category, and tags. Everything is saved to `localStorage`, so your data survives browser closures and restarts — no server needed.
